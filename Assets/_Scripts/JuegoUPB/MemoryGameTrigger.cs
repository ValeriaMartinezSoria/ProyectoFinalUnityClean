...
{
    public string textoPrompt = "Presiona E para el reto de memoria";
    ...
    void Update()
    {
        ...
        {
            if (game == null || game.EstaCompleto()) return;
    ...
    private void OnTriggerEnter(Collider other)
    {
        if (other.CompareTag("Player"))
        {
            ...
            if (promptInteraccion != null)
            {
                ...
                if (tmp != null) tmp.text = textoPrompt;
    ...
    void TerminarJuego()
    {
        jugando = false;
        game.TerminarJuego();
        if (playerNear && promptInteraccion != null) promptInteraccion.SetActive(true);
    }
}